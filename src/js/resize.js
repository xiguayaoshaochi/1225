...
var resize = {
  ...
  shuChange : () => {
    if (vsStatus()) {
      ...
      // wb.ok1.x = 614.8 - changeNum;
      // wb.ok1.y=1430;
      // wb.ok2.x=741.6;
      // wb.ok2.y=1430;
      // wb.ok3.x = 869.9 + changeNum;
      // wb.ok3.y=1430;
      // wb.ok1_icon.x = 614.8 - changeNum;
      // wb.ok1_icon.y = 1430;
      // wb.ok2_icon.x = 741.6;
      // wb.ok2_icon.y = 1430;
      // wb.ok3_icon.x = 869.9 + changeNum;
      // wb.ok3_icon.y = 1430;

      // wb.yellow11.x = 614.8 - changeNum;
      // wb.yellow11.y = 1430;
      // wb.yellow22.x = 741.6;
      // wb.yellow22.y = 1430;
      // wb.yellow33.x = 869.9 + changeNum;
      // wb.yellow33.y = 1430;
    }
  },
  changeBind: () => {
